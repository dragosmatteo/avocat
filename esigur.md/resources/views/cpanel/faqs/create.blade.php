...
@section('content')
  ...
  <form id="form1" class="form-horizontal" action="{{route('faqs.store')}}" method="post" enctype="multipart/form-data">
    ...
    @include('cpanel.form_parts.text', ['data' => '', 'label' => $locales, 'title' => 'ОПИСАНИЕ', 'name' => 'body', 'required' => 'true', 'max' => '1500', 'editor' => 'true' ])

    @include('cpanel.form_parts.number', ['data' => '', 'label' => 'от меньшего к большему', 'title' => 'Приоритет сортировки', 'name' => 'order', 'required' => 'true' ])

    @include('cpanel.form_parts.radio', ['data' => ['Да' => '1', 'Нет' => '0'], 'title' => 'Скрыть faq?', 'name' => 'show', 'checked' => '0' ])
