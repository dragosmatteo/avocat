...
@section('content')
  <header class="page-header">
    <h2>НОВЫЙ ПРЕИМУЩЕСТВО</h2>
  </header>

  <form id="form1" class="form-horizontal" action="{{route('advantages.store')}}" method="post" enctype="multipart/form-data">
    ...
    @include('cpanel.form_parts.radio', ['data' => ['Да' => '1', 'Нет' => '0'], 'title' => 'Скрыть приемущество?', 'name' => 'show', 'checked' => '0' ])
